...
try:
    ...
    for t in result.get('transformers', []):
        print(f"  {t['transformer_id']}: HV={t.get('hv_breaker_number', 'N/A')}, Type={t.get('transformer_type', 'N/A')}, MVA={t.get('capacity_mva', 'N/A')}")
    ...
    # Save for review
    with open('/tmp/gemini_result.json', 'w') as f:
        json.dump(result, f, indent=2)
    print("\nFull result saved to /tmp/gemini_result.json")
