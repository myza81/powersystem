"""
URL configuration for gridshed project.
...
router.register(r'load-shedding-change-logs', LoadSheddingChangeLogViewSet, basename='load-shedding-change-logs')
